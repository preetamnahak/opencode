	...
	<body class="landing">
		<div id="page-wrapper">
				...
				<header id="header" style="position: fixed;z-index: 10000;background-color: black">
					...
					<nav id="nav">
						<ul>
							...
							<li>
								<a href="#project" class=" scrolly" style="font-family:Quicksand">Projects</a>
							</li>
				...
				<section id="banner" style="">
					<div class="content">
						<header>
							...
							<p style="font-family: Quicksand">The Official Open Source Society of NIT Rourkela</p>
						</header>
						...
						<div class="container">
							<div class="row">
								...
								<div class="4u 12u$(medium)">
									<p style="text-align: justify;font-family: Quicksand;font-size: 1.3em">OpenCode is an open source community where we work on projects in which any interested person can join or start his project with us.</p>
								</div>
							</div>
						</div>
					</div>
			...
			<!-- PROJECTS -->
				...
				<div class="container" id="project" style="height: 4em"></div>
				<section >
					<div class="container">								
						<div class="box alt">
					...
					<div class="container">
						...
						<form method="post" action="#" class="container 50%">
							<div class="row uniform 50%">
								<div class="4u"></div>
								<div class="4u$ 12u$(xsmall)"><a class="button special fit" href="signin.php">Get Started</a></div>
								<div class="4u"></div>
							</div>
						</form>
					</div>
			...
			<!-- Footer -->
				<footer id="footer">
					...
					<!-- <div class="container">
						<h4>Contacts:</h4>
						<h5>Design Partner: DesignTab</h5>
						<h5>Faculty Advisor: Prof. Paresh Kale</h5>
					</div> -->
				</footer>
